...
class RetraitOrangePage extends StatefulWidget {
  const RetraitOrangePage({Key? key}) : super(key: key);

  @override
  State<RetraitOrangePage> createState() => _RetraitOrangePageState();
}

class _RetraitOrangePageState extends State<RetraitOrangePage> {
            ...
            child: Column(
              children: [
                ...
                SizedBox(height: 15),
                    ...
                    child: TextFormField(
                      controller: controller.typeOperationController..text = '2',
                      decoration: InputDecoration(
                        border: OutlineInputBorder(),
