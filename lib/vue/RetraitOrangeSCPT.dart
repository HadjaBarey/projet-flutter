...
class RetraitOrangeSCPTPage extends StatefulWidget {
  const RetraitOrangeSCPTPage({Key? key}) : super(key: key);

  @override
  State<RetraitOrangeSCPTPage> createState() => _RetraitOrangeSCPTPageState();
}

class _RetraitOrangeSCPTPageState extends State<RetraitOrangeSCPTPage> {
            ...
            child: Column(
              children: [
                ...
                SizedBox(height: 15),
                    ...
                    child: TextFormField(
                      controller: controller.typeOperationController..text = '3',
                      decoration: InputDecoration(
                        border: OutlineInputBorder(),
